...
from .models import (
    ConfirmationType, Education, Family, FamilyType, Gender, IdentificationType,
    Insuree, InsureePolicy, Profession, Relation,
)
from .gql_queries import (
    ConfirmationTypeGQLType, EducationGQLType, FamilyGQLType, FamilyTypeGQLType,
    GenderGQLType, IdentificationTypeGQLType, InsureeGQLType, InsureePolicyGQLType,
    InsureeStatusReasonGQLType, ProfessionGQLType, RelationGQLType,
)
from .gql_mutations import (
    ChangeInsureeFamilyMutation, CreateFamilyMutation, CreateInsureeMutation,
    DeleteFamiliesMutation, DeleteInsureesMutation, RemoveInsureesMutation,
    SetFamilyHeadMutation, UpdateFamilyMutation, UpdateInsureeMutation,
)
...
class Query(ExportableQueryMixin, graphene.ObjectType):
    ...
    def resolve_insurees(self, info, **kwargs):
        ...
        if not info.context.user._u.is_imis_admin and (kwargs.get('ignore_location') is False or kwargs.get('ignore_location') is None) and not LocationConfig.no_location_check:
